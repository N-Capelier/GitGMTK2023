...
public class FloatLerper : Lerper
{
	#region Private Variables

	Action<float> _lerpAction;

	Func<float, float, float, float> _processFunc;
	...
	public FloatLerper Lerp(float a, float b, float time, Action<float> lerpAction)
	{
	...
	/// <returns>The lerper.</returns>
	public FloatLerper Lerp(float a, float b, float time, Action<float> lerpAction, Action completedAction)
	{
	...
	/// <param name="lerpAction"></param>
	/// <returns>The lerper.</returns>
	public FloatLerper SetLerpAction(Action<float> lerpAction)
	{
		if (lerpAction == null)
		{
	...
	/// <param name="completedAction"></param>
	/// <returns>The lerper.</returns>
	public FloatLerper SetCompletedAction(Action completedAction)
	{
	...
	/// <param name="completedAction"></param>
	/// <returns>The lerper.</returns>
	public FloatLerper SetActions(Action<float> lerpAction, Action completedAction)
	{
	...
	FloatLerper Init(float a, float b, float time, Action<float> lerpAction, Action completedAction, LerpProcessType process)
	{
		if (time < 0f)
		{
